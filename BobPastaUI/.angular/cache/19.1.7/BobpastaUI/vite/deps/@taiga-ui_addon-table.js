...
var TuiTableDirective = class _TuiTableDirective {
  constructor() {
    ...
    this.sortChange = combineLatest([this.sorterChange, this.directionChange]).pipe(debounceTime(0), map(([sortBy, orderBy]) => ({
      sortBy,
      orderBy
    })));
...
var TuiTableSortBy = class _TuiTableSortBy {
  constructor() {
    ...
    this.tuiSortChange = combineLatest([this.tuiSortByChange, this.table.directionChange]).pipe(debounceTime(0), map(([sortBy, orderBy]) => ({
      sortBy,
      orderBy
    })));
    this.tuiSortBy = null;
